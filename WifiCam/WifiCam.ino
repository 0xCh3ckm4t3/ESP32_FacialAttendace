...
const char* WIFI_SSID = "1ST FLOOR";
const char* WIFI_PASS = "pakshala123";

WebServer server(80);

// Flash LED pin (GPIO 4 on most ESP32-CAM boards)
...
void setup()
{
  ...
  server.on("/flash", handleFlash); // New flash endpoint
